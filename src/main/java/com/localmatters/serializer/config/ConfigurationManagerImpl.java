...
/**
 * A refreshable configuration manager
 */
public class ConfigurationManagerImpl extends AbstractRefreshableContent implements ConfigurationManager {
	...
	protected void doRefresh() throws Exception {
		...
		ConfigurationHandler handler = new ConfigurationHandler(getObjectFactory());
		...
		try {
			...
			throw new ConfigurationException(String.format("Unable to load the configuration %s!", getContentSource()), e);
		}
		configs = handler.getConfigs();
	}

	/**
	 * @see com.localmatters.serializer.config.ConfigurationManager#getConfig(java.lang.String)
	 */
