...
import org.localmatters.serializer.test.domain.ChildOfSelfreferencingObject;
import org.localmatters.serializer.test.domain.DummyObject;
import org.localmatters.serializer.test.domain.ObjectWithGenerics;
import org.localmatters.serializer.tool.ConfigWriterFromClass;
...
public class ConfigWriterFromClassTest extends TestCase {
	...
	public void testConfigForObjectWithGenericsDummyObjectAndString() throws Exception {
		...
		assertEquals(resourceToString(resource), ConfigWriterFromClass.getConfiguration(ObjectWithGenerics.class, DummyObject.class, org.localmatters.serializer.test.domain.extra.DummyObject.class, ChildOfSelfreferencingObject.class));
	}
