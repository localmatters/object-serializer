...
/**
 * Class handling the serialization of a name-space definition
 */
public class NamespaceSerialization extends ValueSerialization {
	...
	public void serialize(Serialization ser, String name, Object obj, SerializationContext ctx) throws SerializationException {
		ctx.getWriter().writeNamespace(ser, name, obj, ctx);
	}
